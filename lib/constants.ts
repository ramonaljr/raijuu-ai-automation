...
export const PRICING_PLANS = {
  monthly: [
    ...
    },
    {
      ...
      cta: "Start with Grow",
      popular: true,
      includes: "Everything in Capture, plus:",
    },
    {
      name: "Autopilot",
...
export const FAQS = [
  ...
  },
  {
    ...
    answer:
      "Our plans start at $299/month for a landing page + AI chatbot, $499/month to add paid ads management, and from $1,999/month for the Autopilot tier with workflow automations. Pricing and commitment terms are confirmed on the scoping call.",
  },
  {
    question: "How long does implementation take?",
    answer:
      "Timelines depend on tier and scope. Capture and Grow deployments are faster because they're productized; Autopilot projects take longer because they include custom workflow automations and deeper integrations. You'll see a demo each Friday during the build, so there are no launch-day surprises.",
  },
  {
