...
export default function AuthShell({ title, children, footerSlot }: Props) {
  return (
    <main className="relative min-h-screen w-full bg-dark-bg text-white">
      <div className="grid min-h-screen grid-cols-1 md:grid-cols-[3fr_2fr]">
        {/* Brand panel — hidden on mobile */}
        <section aria-label="Brand" className="relative hidden overflow-hidden md:block">
        ...
        {/* Form panel */}
        <section className="flex items-center justify-center bg-dark-surface px-6 py-16">
